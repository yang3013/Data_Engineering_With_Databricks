...
# MAGIC * Understand the Spark UI
# MAGIC * Navigate the Spark UI
# MAGIC * Interpret various metrics
...
# MAGIC   * What action triggered the first job?
# MAGIC   * What action triggered the second job?
...
# MAGIC    * How many stages are there?
# MAGIC    * Open the **DAG Visualization**. What do you suppose the green dot refers to?
# MAGIC 0. For the second job:
# MAGIC    * How many stages are there?
# MAGIC    * Open the **DAG Visualization**. Why do you suppose the first stage is grey?
# MAGIC    * Can you figure out what transformation is triggering the shuffle at the end of:
# MAGIC      * The first stage?
# MAGIC      * The second stage?
# MAGIC      * The third stage? **Hint**: It's not a transformation, but an action
# MAGIC 0. For the second job, the second stage, how many records (total):
# MAGIC    * Were read in as a result of the previous shuffle operation?
# MAGIC    * Were written out as a result of this shuffle operation? **Hint**: Look for the **Aggregated Metrics by Executor**
...
# MAGIC 0. However, `someDF.take(total)` produced only 1 job and 2 stages
# MAGIC    * Why did it only produce 1 job?
# MAGIC    * Why did the last job only produce 2 stages?
