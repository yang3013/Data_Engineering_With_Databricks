...
-- MAGIC %md
-- MAGIC [11:51 AM] tom hanlon (Guest)
-- MAGIC Database/schema = collection of tables
-- MAGIC 
-- MAGIC [11:51 AM] tom hanlon (Guest)
-- MAGIC DB/schema has a default location
-- MAGIC 
-- MAGIC [11:51 AM] tom hanlon (Guest)
-- MAGIC Table = stored reference to a schema,file format, location
-- MAGIC 
-- MAGIC [11:52 AM] tom hanlon (Guest)
-- MAGIC view = sql statement stored as a table
-- MAGIC 
-- MAGIC temp view = view that is only visible to the current notebook/session
-- MAGIC 
-- MAGIC global temp views = view that is scoped to the cluster
